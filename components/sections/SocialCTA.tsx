    ...
    <section
      ...
      style={{
        background:
          ...
          'linear-gradient(180deg, #fffdf8 0%, #faf3e7 100%)',
      }}
    >
      {/* Top divider glow */}
      <div
        ...
        style={{ background: 'linear-gradient(90deg, transparent, rgba(214,168,79,0.45), transparent)' }}
      />
        ...
        >
          ...
          <div className="glass-card rounded-2xl p-6 text-left group">
            <div className="flex items-center gap-3 mb-3">
              <div
                ...
                style={{ background: 'rgba(214,168,79,0.16)', border: '1px solid rgba(214,168,79,0.45)' }}
              >
          ...
          <div className="glass-card rounded-2xl p-6 text-left group">
            <div className="flex items-center gap-3 mb-3">
              <div
                className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                style={{ background: 'rgba(31,27,22,0.05)', border: '1px solid rgba(31,27,22,0.12)' }}
              >
